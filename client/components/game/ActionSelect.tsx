      ...
      <div className='grid grid-cols-3 gap-4 w-full h-full'>
        ...
        {activeLoading || turnEnded ? (
          ...
          >
            ...
            <button
              value='FIRE'
              className='w-full aspect-square bg-red-600 hover:bg-red-900 text-text dark:text-darkText border-slate-600 border-2 font-bold text-xs sm:text-sm md:text-base lg:text-lg rounded-full flex justify-center items-center overflow-hidden text-ellipsis'
              onClick={(e) => actionClick(e) }
            >
              <GiRocket style={{fontSize: 50, transform: "rotate(270deg)", pointerEvents: "none"}}/>
            </button>
