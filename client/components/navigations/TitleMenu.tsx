  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-radial-custom h-screen max-h-screen text-text flex-col" aria-label="Title Menu">
      <div className=" flex flex-col space-y-10 text-center">
        ...
        <Link to="/user-profile" replace={true} className="w-96 py-6 text-2xl p-3 bg-gradient-to-t from-green-500 to-green-700 text-text rounded-lg shadow-sm shadow-slate-200 hover:bg-none hover:bg-indigo-500">Profile</Link>
      </div>
