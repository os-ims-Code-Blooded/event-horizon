  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-900 dark:bg-black h-screen">
      <div className=" flex flex-col space-y-10">
        <button onClick={(e) => updateView(e)} name="GameBoard" className="w-96 py-6 text-2xl p-3 bg-blue-500 text-white rounded-lg shadow-lg hover:bg-blue-600">Play!</button>
